...
document.getElementById('launch_camera').addEventListener("click", function(event) {
    ...
    DetectRTC.load(function() {
        ...
        if (DetectRTC.isWebRTCSupported == false) {
            ...
            if (DetectRTC.hasWebcam == false) {
                ...
                var camera_body = '<div class="camera_body"><div id="container"> <div id="vid_container"> <video id="video" autoplay playsinline></video> <div id="video_overlay"></div> </div> <div id="gui_controls"> <button id="switchCameraButton" name="switch Camera" type="button" aria-pressed="false"></button> <button id="takePhotoButton" name="take Photo" type="button"></button> <button id="toggleFullScreenButton" name="toggle FullScreen" type="button" aria-pressed="false"></button> </div> </div> </div>';
                $('main, header, footer').hide();
                $('body').append(camera_body);
                $('body').css({'margin': '0px', 'padding': '0px', 'background': '#000'});
...
function createClickFeedbackUI() {
    ...
    // sound feedback
    var sndClick = new Howl({ src: ['/static/public/webapp/snd/click.mp3'] });
